...
<div class="flex flex-col md:flex-row gap-6 p-6 bg-gray-50 min-h-screen">
    ...
    <div class="w-full md:w-1/3 bg-white shadow-sm rounded-md p-6">
        <div class="flex flex-col items-center text-center">
            {{-- Avatar --}}
            <img src="https://randomuser.me/api/portraits/men/75.jpg" class="w-24 h-24 rounded-full mb-4" alt="Avatar">
            ...
            <div class="flex items-center gap-2 mt-4">
                <span id="userIdText" class="text-sm bg-gray-100 px-3 py-1 rounded text-gray-700">
                    User ID: UsrAnKpRSMP1C{{ $user->id }}
                </span>
                <button onclick="copyToClipboard(event)" class="cursor-pointer text-xs text-gray-600 border px-2 py-1 rounded hover:bg-gray-100">
                    Copy
                </button>
            </div>

            <!-- Floating Tooltip -->
            <div id="copyToast" class="absolute z-50 hidden px-3 py-1 bg-white border border-gray-300 text-gray-600 text-xs rounded shadow-sm opacity-0 transition-opacity duration-300">
                Salin
            </div>
        </div>
        ...
        <div class="mt-6 space-y-3">
            ...
            <a href="{{ route('profile_admin.changepass') }}" class="cursor-pointer block w-full text-left px-4 py-2 bg-gray-100 rounded hover:bg-gray-200 text-sm">
                🔐 Ganti Kata Sandi
            </a>

            <a href="{{ route('profile_admin.changephoto') }}" class="cursor-pointer block w-full text-left px-4 py-2 bg-gray-100 rounded hover:bg-gray-200 text-sm">
                🧑‍💼 Ganti Foto Profile
            </a>

            <button class="cursor-pointer w-full text-left px-4 py-2 bg-red-100 rounded hover:bg-red-200 text-sm text-red-700">
                ❌ Hapus Akun Pengguna
            </button>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex items-center gap-2 bg-gray-100 p-2 rounded justify-between">
                        ...
                        <span class="text-green-600 text-xs border border-green-600 px-2 py-0.5 rounded-full bg-transparent">Verified</span>
                    </div>
                </div>
                <div class="md:col-span-2">
