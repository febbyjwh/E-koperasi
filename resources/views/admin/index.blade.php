...
<div class="max-w-sm w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
  <div>
    <form class="w-full">
      ...
      <label for="tenor" class="block mt-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">Masukan
        Tenor:</label>
  ...
  <div class="flex justify-between mb-5">
    <div class="grid gap-4 grid-cols-2">
      <div>
        <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">Kredit
          Manasuka
          ...
          <div data-popover id="clicks-info" role="tooltip"
            ...
            <div class="p-3 space-y-4">
              ...
              <p>Kredit Manasuka adalah pinjaman tunai yang diberikan kepada anggota koperasi. Dana diberikan dalam
                bentuk uang tunai dan bisa digunakan bebas oleh peminjam sesuai kebutuhan.</p>
        ...
        <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">Kredit
          ...
          <div data-popover id="cpc-info" role="tooltip"
            ...
            <div class="p-3 space-y-2">
              ...
              <p>Kredit Barang adalah pembiayaan pembelian barang yang diberikan oleh koperasi. Dana tidak diberikan
                dalam bentuk uang, tapi barang dibeli oleh koperasi dan diserahkan ke anggota.</p>
              <h3 class="font-semibold text-gray-900 dark:text-white">Contoh Perhitungan</h3>
              <ul class="list-disc list-outside pl-6 text-sm text-gray-700 dark:text-gray-200">
                ...
                <li>Propisi 2% = Rp 20.000 → uang yang dibayarkan koperasi ke toko tetap Rp 1.000.000, tapi nilai
                  pembiayaan yang dicairkan ke anggota adalah Rp 980.000</li>
              </ul>
              {{-- <a href="#"
                class="flex items-center font-medium text-blue-600 dark:text-blue-500 dark:hover:text-blue-600 hover:text-blue-700 hover:underline">Read
                more <svg class="w-2 h-2 ms-1.5 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
...
<script>
  ...
  if (document.getElementById("line-chart") && typeof ApexCharts !== 'undefined') {
    const chart = new ApexCharts(document.getElementById("line-chart"), optionsChart);
    chart.render();
  }
</script>
<script>
