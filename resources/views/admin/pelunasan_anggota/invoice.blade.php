...
@section('title', 'Invoice Pelunasan Pinjaman')
    ...
    <div class="p-4 sm:p-7 overflow-y-auto">
      ...
      <div class="mt-5 sm:mt-10 flex flex-col sm:flex-row justify-between gap-5">
        ...
        <div>
          ...
          <div class="text-sm font-medium text-gray-800 dark:text-neutral-200">
            ...
            <span class="text-xs text-gray-500 dark:text-neutral-400">Jam: {{ \Carbon\Carbon::parse($tanggal)->format('H:i') }}</span>
          </div>
        </div>
        <div>
          <span class="block text-xs uppercase text-gray-500 dark:text-neutral-500">Metode:</span>
          <span class="block text-sm font-medium text-gray-800 dark:text-neutral-200">{{ $metode }}</span>
        </div>
      </div>
      ...
      <div class="mt-5 sm:mt-10">
        <p class="text-sm text-gray-500 dark:text-neutral-500">
          ...
          <a class="text-blue-600 hover:underline dark:text-blue-500" href="tel:+62222700003">(022) 2700003</a>
        </p>
      </div>
    </div>
  </div>
