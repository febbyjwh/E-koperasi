    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Nomor Anggota</th>
        ...
        <tbody class="bg-white divide-y divide-gray-200 text-sm text-gray-700">
            <tr>
                ...
                <td class="px-6 py-4 text-right space-x-2">
                    <button class="px-3 py-1 bg-yellow-400 hover:bg-yellow-500 text-white rounded-lg text-xs">Edit</button>
                    <button class="px-3 py-1 bg-red-500 hover:bg-red-600 text-white rounded-lg text-xs">Hapus</button>
                </td>
            </tr>
            <tr>
                <td class="px-6 py-4">2</td>
                <td class="px-6 py-4">AG002</td>
                <td class="px-6 py-4">Siti Aminah</td>
                <td class="px-6 py-4">789012</td>
            ...
            <tr>
                ...
                <td class="px-6 py-4">AG003</td>
                <td class="px-6 py-4">Budi Hartono</td>
                <td class="px-6 py-4">345678</td>
                <td class="px-6 py-4">Laki-laki</td>
                <td class="px-6 py-4">Aktif</td>
