...
{{-- <div class="p-6 bg-white rounded-2xl shadow-lg w-full"> --}}
    <div class="h-screen">
        <form method="POST" enctype="multipart/form-data" action="{{ route('datadiri.step.store', ['step' => 1]) }}">
            @csrf
                    ...
                    <div x-show.transition="step === 'complete'">
                        <div class="bg-white rounded-lg p-10 flex items-center shadow justify-between">
                            <div>
                                ...
                                <h2 class="text-2xl mb-4 text-gray-800 text-center font-bold">Berhasil Mengisi Identitas
                                </h2>
                        ...
                        <div x-show.transition="step != 'complete'">
                            ...
                            <div class="border-b-2 py-4">
                                <div class="uppercase tracking-wide text-xs font-bold text-gray-500 mb-1 leading-tight"
                                    x-text="`Langkah: ${step} dari 3"></div>
                                <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                    <div class="flex-1">
                                        <div x-show="step === 1">
                                            <div class="text-lg font-bold text-gray-700 leading-tight">Data Pribadi
                                            </div>
                                        </div>

                                        <div x-show="step === 2">
                                            <div class="text-lg font-bold text-gray-700 leading-tight">Data
                                                Pekerjaan/Keangotaan</div>
                                        </div>

                                        <div x-show="step === 3">
                                            <div class="text-lg font-bold text-gray-700 leading-tight">Data Keluarga
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="mb-15 mt-5">
                                ...
                                <div x-show.transition.in="step === 1" class="bg-white p-6 rounded-lg shadow-md">
                                    ...
                                    <div class="mb-6 text-center">
                                        <div class="mx-auto"
                                            ...
                                            <img id="image" class="object-cover w-full h-full" :src="image"
                                        ...
                                        <label for="fileInput"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 text-gray-500"
                                        ...
                                        <input type="file" id="fileInput" name="foto_ktp" accept="image/*"
                                            class="hidden" @change="let file = $event.target.files[0]; 
                                            if(file){
                                    ...
                                    <div class="space-y-5">
                                        <div>
                                            <label for="namalengkap" class="font-bold text-gray-700 block mb-1">Nama
                                                Lengkap</label>
                                            <input id="namalengkap" name="nama_lengkap" type="text"
                                        ...
                                        <div>
                                            <label for="nik" class="font-bold text-gray-700 block mb-1">Nomber Induk
                                                Kependudukan (NIK)</label>
                                            <input id="nik" type="text"
                                                placeholder="Masukan nomber induk kependudukan..."
                                                class="w-full px-4 py-3 rounded-lg border shadow-sm focus:outline-none focus:border-blue-500 text-gray-700">
                                        </div>

                                        <div>
                                            <label for="username" class="font-bold text-gray-700 block mb-1">Nama
                                                Pengguna</label>
                                        ...
                                        <div>
                                            <label for="ulangtahun" class="font-bold text-gray-700 block mb-1">Tanggal
                                                Lahir</label>
                                        ...
                                        <div>
                                            <label for="gender" class="font-bold text-gray-700 block mb-1">Jenis
                                                Kelamin</label>
                                            <select id="gender"
                                                class="w-full px-4 py-3 rounded-lg border shadow-sm focus:outline-none focus:border-blue-500 text-gray-700">
                                        ...
                                        <div>
                                            <label for="nomor" class="font-bold text-gray-700 block mb-1">Nomor
                                                WhatsApp</label>
                                        ...
                                        <div>
                                            <label for="alamat" class="font-bold text-gray-700 block mb-1">Alamat
                                                KTP</label>
                                ...
                                <div x-show.transition.in="step === 2"
                                    class="bg-white p-6 rounded-lg shadow-md relative z-0">

                                    <div class="space-y-5">
                                        <div>
                                            <label for="noanggota" class="font-bold text-gray-700 block mb-1">No
                                                Anggota</label>
                                        ...
                                        <div>
                                            <label for="jabatan" class="font-bold text-gray-700 block mb-1">Jabatan /
                                                Posisi</label>
                                            <input id="jabatan" type="text"
                                                placeholder="Contoh: Guru Matematika, Staff Tata Usaha, Kepala Sekolah, dll."
                                                class="w-full px-4 py-3 rounded-lg border shadow-sm focus:outline-none focus:border-blue-500 text-gray-700">
                                        </div>

                                        <div>
                                            <label for="unitkerja" class="font-bold text-gray-700 block mb-1">Unit Kerja
                                                / Departemen</label>
                                            <input id="unitkerja" type="text"
                                                placeholder="Contoh: Tata Usaha, Kurikulum, Kesiswaan, Laboratorium."
                                                class="w-full px-4 py-3 rounded-lg border shadow-sm focus:outline-none focus:border-blue-500 text-gray-700">
                                        </div>

                                        <div>
                                            <label for="tglmulai" class="font-bold text-gray-700 block mb-1">Tanggal
                                                Mulai Kerja</label>
                                        ...
                                        <div>
                                            <label for="statuskepegawaian"
                                                class="font-bold text-gray-700 block mb-1">Status Kepegawaian</label>
                                        ...
                                        <div>
                                            <label for="tglbergabung" class="font-bold text-gray-700 block mb-1">Tanggal
                                                Bergabung</label>
                                        ...
                                        <div>
                                            <label for="statusanggota" class="font-bold text-gray-700 block mb-1">Status
                                                Keanggotaan</label>
                                ...
                                <div x-show.transition.in="step === 3"
                                    ...
                                    <div class="space-y-5">
                                        <div>
                                            <label for="namawali" class="font-bold text-gray-700 block mb-1">Nama
                                                Anggota Keluarga</label>
                                            <input id="namawali" type="text"
                                                placeholder="Masukan nama anggota keluarga..."
                                                class="w-full px-4 py-3 rounded-lg border shadow-sm focus:outline-none focus:border-blue-500 text-gray-700" />
                                        </div>

                                        <div>
                                            <label for="hubunganwali"
                                                class="font-bold text-gray-700 block mb-1">Hubungan dengan
                                                Anggota</label>
                                        ...
                                        <div>
                                            <label for="notelpwali" class="font-bold text-gray-700 block mb-1">Nomor
                                                Telepon Anggota Keluarga</label>
                                            <input id="notelpwali" type="text"
                                                placeholder="Masukan nomor telepon anggota keluarga..."
                                                class="w-full px-4 py-3 rounded-lg border shadow-sm focus:outline-none focus:border-blue-500 text-gray-700" />
                                        </div>

                                        <div>
                                            <label for="alamatwali" class="font-bold text-gray-700 block mb-1">Alamat
                                                anggota keluarga</label>
                                            <textarea id="alamatwali" rows="3"
                                                placeholder="Masukan alamat anggota keluarga..."
                                                class="w-full px-4 py-3 rounded-lg border shadow-sm focus:outline-none focus:border-blue-500 text-gray-700"></textarea>
                                        </div>

                                        <div>
                                            <label for="emailwali" class="font-bold text-gray-700 block mb-1">Email
                                                anggota keluarga (Opsional)</label>
                                            <input id="emailwali" type="email"
                                                placeholder="Masukan email anggota keluarga..."
                                                class="w-full px-4 py-3 rounded-lg border shadow-sm focus:outline-none focus:border-blue-500 text-gray-700" />
                                        </div>
                                    </div>
