...
@section('title', 'Tabungan Wajib Anggota')

@section('content')
<div class="p-4 bg-white rounded-2xl shadow-lg">
    <div class="flex items-center justify-between mb-4">
        <h2 class="text-sm md:text-xl font-semibold text-gray-700">Tabungan Wajib Saya</h2>
        
        <form action="{{ route('tab_wajib_anggota.index') }}" method="GET" class="max-w-md w-full mr-4">
            <div class="relative">
