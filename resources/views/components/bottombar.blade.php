<div
    ...
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        <button data-tooltip-target="tooltip-home" type="button"
            ...
            <svg class="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-teal-600 dark:group-hover:text-teal-500"
        ...
        <div class="flex items-center justify-center">
            <button data-tooltip-target="tooltip-new" type="button"
                class="inline-flex items-center justify-center w-10 h-10 font-medium bg-teal-600 rounded-full hover:bg-teal-700 group focus:ring-4 focus:ring-teal-300 focus:outline-none dark:focus:ring-teal-800">
